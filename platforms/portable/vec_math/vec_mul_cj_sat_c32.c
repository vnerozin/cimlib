...
bool test_vec_mul_cj_sat_c32(void)
{
    cint32_t z[4];
    static cint32_t x[4] = {
        {123456789, 98785432}, {1234567890, 98785432},
        {1234567890, 98785432}, {123456789, 98785432}
    };
    static cint32_t y[4] = {
        {98785432, 123456789}, {98785432, -1234567890},
        {-98785432, 1234567890}, {-98785432, -123456789}
    };
