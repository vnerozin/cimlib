...
/*******************************************************************************
 * This function tests 'vec_mul_cj_c16' function. Returns 'true' if validation
...
bool test_vec_mul_cj_c16(void)
{
    ...
    static cint16_t res[4] = {
        {8185, -7501}, {0, 11102}, {0, -11103}, {-8186, 7500}
    };
    bool flOk = true;

    /* Call 'vec_mul_cj_c16' function */
    vec_mul_cj_c16(z, 4, 14, x, y);
