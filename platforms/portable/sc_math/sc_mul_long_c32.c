...
/*******************************************************************************
 * This function multiplies two input values, 32 bit complex, result with
 * extended precision.
 *
 * @param[in]  x  Input value, 32 bit complex.
 * @param[in]  y  Input value, 32 bit complex.
 *
 * @return        Multiply of input values, 64 bit complex.
 ******************************************************************************/
...
/*******************************************************************************
 * This function tests 'sc_mul_long_c32' function. Returns 'true' if
...
bool test_sc_mul_long_c32(void)
{
    ...
    /* Call 'sc_mul_long_c32' function */
    for (n = 0; n < 4; n++) {
        z[n] = sc_mul_long_c32(x[n], y[n]);
    }
