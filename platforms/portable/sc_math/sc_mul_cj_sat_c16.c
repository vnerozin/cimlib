 ...
 *
 * @return            Conjugate multiply of input values, 16 bit complex.
 ******************************************************************************/
...
/*******************************************************************************
 * This function tests 'sc_mul_cj_sat_c16' function. Returns 'true' if
...
bool test_sc_mul_cj_sat_c16(void)
{
    ...
    static cint16_t res[4] = {
        ...
        {INT16_MAX, INT16_MAX},
        {INT16_MIN, CONST(-8.3581542969E-01)},
        CONST_CPLX(-4.9505615234E-01,  4.5355224609E-01)
    };
    bool flOk = true;

    /* Call 'sc_mul_cj_sat_c16' function */
    for (n = 0; n < 4; n++) {
        z[n] = sc_mul_cj_sat_c16(x[n], y[n], RADIX);
    }
