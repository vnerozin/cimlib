...
/*******************************************************************************
 * This function multiplies two input values, 16 bit complex, result is
 ...
 ******************************************************************************/
cint32_t sc_mac_long_c16(cint16_t x, cint16_t y, cint32_t acc)
{
...
/*******************************************************************************
 * This function tests 'sc_mac_long_c16' function. Returns 'true' if validation
 * is successfully done, 'false' - otherwise.
 ******************************************************************************/
bool test_sc_mac_long_c16(void)
{
    int n;
    cint32_t acc = {0, 0};
    static cint16_t x[4] = {
    ...
    /* Call 'sc_mac_long_c16' function */
    for (n = 0; n < 4; n++) {
        acc = sc_mac_long_c16(x[n], y[n], acc);
    }
