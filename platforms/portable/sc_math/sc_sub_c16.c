...
/*******************************************************************************
 * This function perform subtraction of input values, 16 bit complex.
 *
 * @param[in]  x  Input value, 16 bit complex.
 * @param[in]  y  Input value, 16 bit complex.
 *
 * @return        Result of subtraction, 16 bit complex.
 ******************************************************************************/
...
/*******************************************************************************
 * This function tests 'sc_sub_c16' function. Returns 'true' if validation
...
bool test_sc_sub_c16(void)
{
    ...
    /* Call 'sc_sub_c16' function */
    for(n = 0; n < 4; n++) {
        z[n] = sc_sub_c16(x[n], y[n]);
    }
