...
/*******************************************************************************
 * This function tests 'sc_mac_c16' function. Returns 'true' if validation
...
bool test_sc_mac_c16(void)
{
    ...
    static cint16_t res = CONST_CPLX(2.6835937500E+00, 0);
    bool flOk = true;

    /* Call 'sc_mac_c16' function */
    for (n = 0; n < 4; n++) {
        acc = sc_mac_c16(x[n], y[n], acc, RADIX);
    }
