 ...
 ******************************************************************************/
cint64_t sc_mac_cj_long_c32(cint32_t x, cint32_t y, cint64_t acc)
{
...
/*******************************************************************************
 * This function tests 'sc_mac_cj_long_c32' function. Returns 'true' if
 * validation is successfully done, 'false' - otherwise.
 ******************************************************************************/
bool test_sc_mac_cj_long_c32(void)
{
    int n;
    cint64_t acc = {0, 0};
    static cint32_t x[4] = {
    ...
    /* Call 'sc_mac_cj_long_c32' function */
    for (n = 0; n < 4; n++) {
        acc = sc_mac_cj_long_c32(x[n], y[n], acc);
    }
